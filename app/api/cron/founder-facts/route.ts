/**
 * GET /api/cron/founder-facts — başvuru formları için tek doğru rakam kaynağı.
 *
 * 2026-09-15: hızlandırıcı/yatırımcı başvuruları (TalTech, Tehnopol, Startup
 * Estonia, YC…) aynı soruları soruyor: trafik, dönüşüm, kapsam, gelir. Rakamlar
 * elle yazılınca birkaç hafta içinde bayatlıyor ya da yuvarlanıp şişiyor.
 * n8n başvuru akışı cevap taslaklarını yalnızca bu uçtan gelen değerlerle yazar.
 *
 * Güvenlik: x-cron-secret (timing-safe). Kişisel veri dönmez — yalnız toplamlar.
 */
