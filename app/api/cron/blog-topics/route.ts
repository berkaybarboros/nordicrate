...
function buildBrief(t: NonNullable<ReturnType<typeof nextTopic>>, today: string): string {
  return [
    ...
    '  Keep it to MAX 4 columns and write separator rows as |---|---| (nothing longer).',
    '  Wide tables with long dashed separators made the model loop and broke publishing',
    '  for 12 days in August 2026 — keep them narrow.',
